...
| **Probe HTTP en hosts silenciosos** | vNext | `redaudit/core/auditor_scan.py`, `redaudit/core/scanner.py`. Probe HTTP/HTTPS breve en puertos comunes para hosts con vendor y cero puertos abiertos. |
