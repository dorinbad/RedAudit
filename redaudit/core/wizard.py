...
{self.COLORS['FAIL']}
   ...
   / __ \\___  ___/ /  {self.COLORS['BOLD']}{self.COLORS['HEADER']}/   | __  ______/ (_) /_{self.COLORS['ENDC']}{self.COLORS['FAIL']}
  / /_/ / _ \\/ _  /  {self.COLORS['BOLD']}{self.COLORS['HEADER']}/ /| |/ / / / __  / / __/{self.COLORS['ENDC']}{self.COLORS['FAIL']}
