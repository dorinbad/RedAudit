...
TRANSLATIONS = {
    "en": {
        ...
        "ask_num_limit": "Maximum number of hosts to scan (ENTER = all, or type a number):",
    ...
    "es": {
        ...
        "ask_num_limit": "Número máximo de hosts a escanear (ENTER = todos, o escribe un número):",
