#!/bin/bash
# RedAudit Installer v2.6.1 (Clean install + Language injection + Alias setup)
...
if [[ "$LANG_OPT" == "2" ]]; then
    LANG_CODE="es"
    MSG_INSTALL="[INFO] Instalando/actualizando RedAudit v2.6.1..."
    ...
    LANG_CODE="en"
    MSG_INSTALL="[INFO] Installing/updating RedAudit v2.6.1..."
